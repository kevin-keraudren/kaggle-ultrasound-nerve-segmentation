...
for f_seg in all_segs:
    ...
    img = img[pad_size+center[0]-shape_img[0]//2:pad_size+center[0]+shape_img[0]//2,
              pad_size+center[1]-shape_img[1]//2:pad_size+center[1]+shape_img[1]//2]
    seg = seg[pad_size+center[0]-shape_seg[0]//2:pad_size+center[0]+shape_seg[0]//2,
              pad_size+center[1]-shape_seg[1]//2:pad_size+center[1]+shape_seg[1]//2]
